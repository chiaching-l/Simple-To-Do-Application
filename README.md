...
_You should see the following messages indicating the server and database are active:_
...
_The application will automatically open in your default browser at:_
http://localhost:3000
